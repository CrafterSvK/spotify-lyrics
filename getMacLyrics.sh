...
#get html file
wget -q --header="Accept: text/html" --user-agent="Mozilla/5.0 (Macintosh; Intel Mac OS X 10.8; rv:21.0) Gecko/20100101 Firefox/21.0" -O lyrics.html $website

#remove unwanted things
lyrics=$(sed -n "/<div>/,/<\/div>/p" lyrics.html)
...
#center all text
sed -i '1s/^/<center>\n/' lyrics.html
echo "</center>" >> lyrics.html

#Change w3m to your browser
w3m lyrics.html
